...
k = !is.na(genieClinData$age_days)
ggplot(genieClinData[k,],aes(x=(age_days/365),group=CENTER))+geom_histogram(aes(y = (..count..)/width/tapply(..count..,..group..,sum)[..group..]),breaks=c(0,seq(1,89,2),90,108),closed="left")+facet_wrap(~CENTER,ncol=4)
